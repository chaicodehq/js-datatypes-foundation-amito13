  ...
  export function roundFare(amount, decimalPlaces) {
    ...
    if(typeof decimalPlaces !=="number" || !Number.isInteger(decimalPlaces)|| decimalPlaces <0){ return ""} //isme jda dhyan dena h
  ...
  export function calculateSurge(baseFare, surgeMultiplier) {
    ...
    let prd = surgeMultiplier*baseFare

    return Math.ceil(prd)
  }
